...
export const sampleEssays: Essay[] = [
  {
    ...
    duration: 900,
    audioUrl: 'essays/intro-to-ifs.mp3',
  ...
  },
  {
    ...
    author: 'IFS Meditation App',
    duration: 720,
    audioUrl: 'essays/understanding-protectors.mp3',
    category: 'Foundations',
  ...
  },
  {
    ...
    author: 'IFS Meditation App',
    duration: 840,
    audioUrl: 'essays/meeting-exiles.mp3',
  ...
  },
  {
    ...
    author: 'IFS Meditation App',
    duration: 780,
    audioUrl: 'essays/self-leadership.mp3',
    category: 'Practice',
  ...
  },
  {
    ...
    author: 'IFS Meditation App',
    duration: 810,
    audioUrl: 'essays/inner-critic.mp3',
    category: 'Going Deeper',
...
export const sampleMeditations: Meditation[] = [
  {
    ...
    duration: 600,
    audioUrl: 'meditations/finding-self.mp3',
    category: 'Beginner',
    type: 'guided',
    targetPart: 'Self',
  ...
  },
  {
    ...
    duration: 900,
    audioUrl: 'meditations/befriending-protector.mp3',
  ...
  },
  {
    ...
    duration: 720,
    audioUrl: 'meditations/inner-critic.mp3',
    category: 'Core Practice',
    type: 'guided',
  ...
  },
  {
    ...
    duration: 480,
    audioUrl: 'meditations/parts-checkin.mp3',
  ...
  },
  {
    ...
    duration: 1200,
    audioUrl: 'meditations/healing-exile.mp3',
    category: 'Advanced',
    type: 'guided',
    targetPart: 'Exile',
  ...
  },
  {
    ...
    duration: 900,
    audioUrl: 'meditations/self-led-body-scan.mp3',
    category: 'Daily Practice',
    type: 'guided',
    targetPart: 'Body',
  ...
  },
  {
    ...
    duration: 1080,
    audioUrl: 'meditations/unburdening.mp3',
    category: 'Advanced',
    type: 'guided',
    targetPart: 'Exile',
  ...
  },
  {
    ...
    duration: 600,
    audioUrl: 'meditations/open-awareness.mp3',
    category: 'Daily Practice',
    type: 'unguided',
